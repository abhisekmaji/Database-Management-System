...
FROM
    ...
    FROM
        ...
        GROUP BY table1.bowling_id, table1.bowling_skill
        )as table2

        JOIN

        (SELECT table3.striker, player.bowling_skill, player.player_name, ROUND(AVG(table3.tot_runs),2) as avg_runs
        FROM
        ...
        GROUP BY table3.striker, player.bowling_skill, player.player_name
        )as table4 ON table2.bowling_id = table4.bowling_skill
